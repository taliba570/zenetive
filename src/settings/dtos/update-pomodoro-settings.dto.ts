...
export class UpdatePomodoroSettingsDto {
  ...
  @ApiProperty({
    example: 8,
    description: 'Daily pomodoro target sessions',
    default: 8,
  })
  readonly dailyPomodoroTarget: number;
}

export class UpdateWorkDurationDto {
  @ApiProperty({
    example: 25,
    description: 'Work duration in minutes',
    default: 25,
...
export class UpdateShortBreakDurationDto {
  @ApiProperty({
    example: 5,
    description: 'Short break duration in minutes',
    default: 5,
...
export class UpdateLongBreakDurationDto {
  @ApiProperty({
    example: 15,
    description: 'Long break duration in minutes',
    default: 15,
