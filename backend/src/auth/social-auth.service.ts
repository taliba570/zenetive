...
export class SocialAuthService {
  private readonly googleUserInfo: string =
    process.env.GOOGLE_USER_INFO ||
    'https://www.googleapis.com/oauth2/v1/userinfo';
  private readonly googleOAuth: string =
    process.env.GOOGLE_OAUTH_URL || 'https://oauth2.googleapis.com/token';
  private readonly googleClientId: string =
    process.env.GOOGLE_CLIENT_ID ||
    '1095986755368-l4i718bqntmup4u49h09de7op3j41j42.apps.googleusercontent.com';
  private readonly googleClientSecret: string =
    process.env.GOOGLE_CLIENT_SECRET || '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';
