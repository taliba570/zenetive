        ...
        <div className="container w-full mx-auto flex flex-col items-center justify-start text-white">
            ...
            <div className="header flex h-[70px] justify-between items-center gap-32">
                ...
                <div className="cta">
                    <ul className='flex border-1 p-[2px] rounded-2xl border-2 h-[46px] openSans-SemiBold'>
                        <li className='mr-[2px] px-4 py-2 hover:bg-gray-100 text-[#464646] flex hover:cursor-pointer rounded-xl items-center justify-center'>Login</li>
            ...
            <div className="main w-full">
                <div className="hero-section w-4/6 mx-auto py-10">
                    <h1 className='text-black text-6xl openSans-ExtraBold text-center pt-16'>Unlock Your Full Potential</h1>
                    <h2 className='text-black text-2xl w-5/6 mx-auto openSans-Regular font-bold text-center pt-4 pb-10'>Stay focused, track progress, and boost performance with personalized insights and powerful tools—all in one place.</h2>
